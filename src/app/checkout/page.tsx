        ...
        <div className="space-y-8 lg:col-span-2">
          ...
          <fieldset>
            <div className="flex items-center justify-between">
              <legend className="font-display text-lg">Payment Details</legend>
              <div className="flex items-center gap-1.5 text-xs text-muted">
                <span className="rounded border border-line bg-paper-2 px-1.5 py-0.5 text-[10px] font-semibold text-ink">VISA</span>
                <span className="rounded border border-line bg-paper-2 px-1.5 py-0.5 text-[10px] font-semibold text-ink">MC</span>
                <span className="rounded border border-line bg-paper-2 px-1.5 py-0.5 text-[10px] font-semibold text-ink">AMEX</span>
              </div>
            </div>
