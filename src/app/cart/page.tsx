      ...
      <div className="mt-8 grid gap-10 lg:grid-cols-3">
        ...
        <div className="h-fit rounded-2xl border border-line bg-paper-2/50 p-6 shadow-sm space-y-6">
          ...
          <div className="border-t border-line pt-4 text-center space-y-2">
            ...
            <div className="flex justify-center gap-1.5 text-[10px] font-bold text-ink/60">
              <span className="rounded border border-line bg-paper px-1.5 py-0.5">VISA</span>
              <span className="rounded border border-line bg-paper px-1.5 py-0.5">MASTERCARD</span>
              <span className="rounded border border-line bg-paper px-1.5 py-0.5">AMEX</span>
              <span className="rounded border border-line bg-paper px-1.5 py-0.5">APPLE PAY</span>
            </div>
          </div>
